  ...
  return (
    <div id="container" className="h-full bg-bglp px-4 lg:px-[135px]">
      ...
      <div className="max-w-[1170px] w-full flex justify-between pt-6">
        ...
        <button 
          className="max-w-[120px] w-full h-10 rounded bg-primary text-white text-base font-medium hover:bg-btn-hover sm:h-12"
          onClick={() => signIn()}
        >
          Entrar
        </button>
        ...
        <div className="col-span-6">
          <div className="relative">
            ...
            <div className="relative z-10">
              ...
              <button
                className="max-w-[170px] w-full h-10 bg-primary rounded text-white font-medium text-base mt-[72px] hover:bg-btn-hover sm:h-12"
                onClick={() => signIn()}
              >
                Entrar
              </button>
